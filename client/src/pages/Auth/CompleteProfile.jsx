    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-8 sm:py-12 w-full transition-colors duration-200">
      <div className="w-full max-w-md mx-auto">
        <div className="bg-white rounded-xl shadow-lg p-6 sm:p-8 border border-transparent">
          ...
          {error && <div className="text-red-600 text-sm mb-4 text-center bg-red-50 border border-red-200 rounded-lg p-2">{error}</div>}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      disabled={loading}
                      className="px-4 py-2.5 bg-white text-black rounded-lg text-sm sm:text-base font-medium hover:bg-gray-100 transition disabled:opacity-50"
                    >
                      {loading ? 'Adding...' : 'Add'}
                    </button>
                  </div>
            ...
            <button type="submit" disabled={loading} className="w-full bg-white text-black py-2.5 rounded-lg text-sm sm:text-base font-medium hover:bg-gray-100 transition disabled:opacity-50">
