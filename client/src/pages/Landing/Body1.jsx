          ...
          <div className='animate-fade-in'>
            ...
            <div className='mt-8 sm:mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 px-4'>
              <button
                ...
                className='w-full sm:w-auto px-8 py-4 bg-white text-black text-base font-medium rounded-full hover:bg-gray-100 hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl'
              >
                Get Started Free →
              </button>
              <button
